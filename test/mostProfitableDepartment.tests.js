...
describe('The mostProfitableDepartment function test' , function(){
    it('Should return Outdoor for most profitable department in dataset 1' , function(){
        assert.deepEqual("outdoor",mostProfitableDepartment(salesData), 'Outdoor');
    });
    
    it('Should return Electronics for most profitable department in dataset 2' , function(){
